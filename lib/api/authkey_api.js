...
module.exports = class AuthkeyAPI extends BaseAPI {
     ...
     * @return { Client API key } json object of 'Client API key'
     */
     ...
     * @return { List of Client API Keys } json object of 'List of Client API Keys'
     */
    async getClientKeys(){
        let url = "/v1/authkey/clients";
        let data = {};
     ...
     * @return { Debug API Key } json object of 'Debug API Key'
     */
    async debugKey(){
