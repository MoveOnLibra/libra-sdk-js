...
module.exports = class TransactionAPI extends BaseAPI {
    async getTransaction(version){
        this.checkParam(version, "version", "integer", true);
    ...
    async getTransactions(start_version, limit){
        this.checkParam(start_version, "start_version", "integer", true);
        this.checkParam(limit, "limit", "integer", false);
    ...
    async getByAccountSeq(account_address, sequence_number){
        this.checkParam(account_address, "account_address", "string", true);
        this.checkParam(sequence_number, "sequence_number", "integer", true);
    ...
    async mint(receiver_account_address, number_of_micro_libra, force_offical){
        this.checkParam(receiver_account_address, "receiver_account_address", "string", true);
        this.checkParam(number_of_micro_libra, "number_of_micro_libra", "integer", true);
        this.checkParam(force_offical, "force_offical", "integer", false);
    ...
    async p2pTransfer(wallet_id, sender_account_address, receiver_account_address, number_of_micro_libra){
        this.checkParam(wallet_id, "wallet_id", "integer", true);
